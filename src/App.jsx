...
const LIGHT = {
  ...
  clay: "#2596be", clayDeep: "#2596be", clayWash: "#FAF9F5", clayOnWhite: "#2596be",
  sage: "#788C5D", sageWash: "#FAF9F5", sageOnWhite: "#5F7048",
  rustRed: "#B85C50", rustWash: "#FAF9F5", rustOnWhite: "#B85C50", dangerBg: "#DC2626",
  amber: "#2596be", amberWash: "#FAF9F5", amberOnWhite: "#2596be",
  inputBg: "#FAF9F5", inputText: "#141413", inputPlaceholder: "#AFAEA9", inputBorder: "#C2C0B8",
  btnAccent: "#2596be", btnAccentBorder: "#2596be", btnAccentWash: "#FAF9F5",
  btnAccentText: "#2596be", btnAccentTextActive: "#FFFFFF",
  navActiveBg: "rgba(37, 150, 190, 0.12)",
  ...SHADOW_LIGHT,
};
const DARK = {
  ...
  clay: "#2596be", clayDeep: "#2596be", clayWash: "#262624", clayOnWhite: "#2596be",
  sage: "#788C5D", sageWash: "#262624", sageOnWhite: "#9CB27E",
  rustRed: "#D28A7E", rustWash: "#262624", rustOnWhite: "#D28A7E", dangerBg: "#E23F3F",
  amber: "#2596be", amberWash: "#262624", amberOnWhite: "#2596be",
  inputBg: "#262624", inputText: "#FAF9F5", inputPlaceholder: "#6E6C64", inputBorder: "#6E6C63",
  btnAccent: "#2596be", btnAccentBorder: "#2596be", btnAccentWash: "#262624",
  btnAccentText: "#2596be", btnAccentTextActive: "#FFFFFF",
  navActiveBg: "rgba(37, 150, 190, 0.18)",
  ...SHADOW_DARK,
};
